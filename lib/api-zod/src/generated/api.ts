...
export const CreateWriteOffResponse = zod.object({
  "id": zod.number(),
  "itemId": zod.number(),
  "itemName": zod.string().nullish(),
  "quantity": zod.number(),
...
export const DeleteWriteOffResponse = zod.void()
...
export const ListInventoryAuditsResponse = zod.array(ListInventoryAuditsResponseItem)
...
export const GetAnalyticsCategoryBreakdownResponse = zod.array(GetAnalyticsCategoryBreakdownResponseItem)
...
export const GetAnalyticsSpendingOverTimeQueryParams = zod.object({
  "period": zod.enum(['day', 'week', 'month', 'year']).default(getAnalyticsSpendingOverTimeQueryPeriodDefault)
})
...
export const GetAnalyticsSpendingOverTimeResponse = zod.array(GetAnalyticsSpendingOverTimeResponseItem)
...
export const GetAnalyticsTopWriteOffsResponse = zod.array(GetAnalyticsTopWriteOffsResponseItem)
...
export const GetAnalyticsLowStockResponse = zod.array(GetAnalyticsLowStockResponseItem)
 ...
 */
export const ExportStockResponse = zod.unknown()
...
export const ExportWriteOffsResponse = zod.unknown()
...
export const GetAnalyticsActiveRentalsResponse = zod.array(GetAnalyticsActiveRentalsResponseItem)
