...
router.post("/staff", requireAuth(), requireRole("warehouse_chief"), async (req: Request, res: Response) => {
...
router.patch("/staff/:id", requireAuth(), requireRole("warehouse_chief"), async (req: Request, res: Response) => {
...
router.delete("/staff/:id", requireAuth(), requireRole("warehouse_chief"), async (req: Request, res: Response) => {
  const id = Number(req.params.id);
