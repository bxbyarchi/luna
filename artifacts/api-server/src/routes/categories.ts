...
router.post("/categories", requireAuth(), requireRole("warehouse_chief"), async (req: Request, res: Response) => {
...
router.patch("/categories/:id", requireAuth(), requireRole("warehouse_chief"), async (req: Request, res: Response) => {
...
router.delete("/categories/:id", requireAuth(), requireRole("warehouse_chief"), async (req: Request, res: Response) => {
  const id = Number(req.params.id);
