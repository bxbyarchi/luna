...
router.post("/rentals", requireAuth(), requireRole("warehouse_chief"), async (req: Request, res: Response) => {
...
router.patch("/rentals/:id", requireAuth(), requireRole("warehouse_chief"), async (req: Request, res: Response) => {
  const id = Number(req.params.id);
